  ...
  return (
    <div className="min-h-screen bg-gradient-hero">
      ...
      <header className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <Palette className="h-12 w-12 md:h-14 md:w-14 text-white" />
            <h1 className="text-4xl md:text-5xl font-bold text-white font-brand">Cover Artisan</h1>
          </div>
          <Button 
            variant="secondary" 
      ...
      <footer className="container mx-auto px-4 py-8 text-center text-white/80">
        <p>&copy; 2025 Cover Artisan. Create amazing book covers with AI.</p>
      </footer>
    </div>
  );
};
